            ...
            <div class="cart-drawer" id="cart-drawer">
                ...
                <div class="cart-footer">
                    ...
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:12px; margin-bottom:12px">
                        <button class="btn-checkout" onclick="location.href='cart.html'" style="background:#F5F0E8; color:#2C1F14; width:100%; border:none; padding:12px; font-weight:600; cursor:pointer; border-radius:6px">View Cart</button>
                        <button class="btn-checkout" onclick="location.href='checkout.html'" style="background:#2C1F14; color:#fff; width:100%; border:none; padding:12px; font-weight:600; cursor:pointer; border-radius:6px">Checkout</button>
                    </div>
...
function initSearchBar() {
    ...
    input.addEventListener('keypress', (e) => {
        if (e.key === 'Enter') {
            ...
            if (query) location.href = `shop.html?search=${encodeURIComponent(query)}`;
        }
    });
